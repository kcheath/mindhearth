...
class TestConfig {
  ...
  static const String swaggerUrl = 'http://localhost:8000/docs';
  static const String redocUrl = 'http://localhost:8000/redoc';
  static const String openApiUrl = 'http://localhost:8000/openapi.json';
